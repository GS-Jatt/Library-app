"use strict";
import { books, users, hidAll } from "./get-data.js";
...
let rUser;
document
  .getElementById("return-book-id")
  .addEventListener("change", function (e) {
    loop1: for (let book of books) {
...
document
  .getElementById("return-book-form")
  .addEventListener("submit", function (e) {
    ...
    fetch("https://api.jsonbin.io/v3/b/64081c59c0e7653a058439f8?meta=false ", {
      ...
      headers: {
        ...
        "X-Access-Key":
          "$2b$10$yCt1TczM9drUVreBsiuKjubH1z/W5ZkloK7Aj/NQFxAbBiqWNN8OO",
      },
    });
