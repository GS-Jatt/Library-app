"use strict";
import { savedLogin } from "./login.js";
...
const BookData = async function () {
  const books = await fetch(
    "https://api.jsonbin.io/v3/b/64081c59c0e7653a058439f8?meta=false",
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
        "X-Access-Key":
          "$2b$10$vVrdTC03qN6B66LyKf/0J.yZGnHCjlof.xcPgr7nNPgwKL4Z5AevK",
      },
    },
  );
  return books.json();
...
const UsersData = async function () {
  const req = await fetch(
    "https://api.jsonbin.io/v3/b/64030be9ace6f33a22e92074?meta=false ",
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
